...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/G3a3AQndqS5J45eD7zznXF', "groupName": `Xeon Bot Inc.`, "footerText": "*sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 1: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 2: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 3: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 4: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 5: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 6: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 7: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 8: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 9: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 10: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 11: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 12: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 13: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 14: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 15: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 16: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 17: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 18: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 19: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 20: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 21: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 22: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
                case 23: jamss = "sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/380945798078?text=*💌🥰sᴋ.ᴅᴇᴠɪʟ.sᴇʀ.ʙɪɢ.ғᴇɴ💌🥰`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
ini_list.push({
"displayName": `sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ Developer`,
...
_BASE : Sk Bot Inc._
_ORI SCRIPT : sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ Script`,
...
const btnbc = {
    ...
    footerText: '*_sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `sᴋ ᴅᴇᴠɪʟ ʙᴏᴛ`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
