//-----(Sk Devil Bot by Sk Devil Bot Inc.)-----\\
//-----(Youtube Channel: Sk)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '@g.us', "inviteCode": 'https://chat.whatsapp.com/', "groupName": `Sk Bot Inc.`, "footerText": "*ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 1: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 2: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 3: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 4: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 5: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 6: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 7: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 8: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 9: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 10: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 11: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 12: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 13: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 14: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 15: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 16: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 17: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 18: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 19: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 20: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 21: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 22: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
                case 23: jamss = "ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/380945798078`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://github.com/Skuu07')
}
...
ini_list.push({
"displayName": `ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ Developer`,
...
_BASE : Sk Bot Inc._
_ORI SCRIPT : ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ Script`,
          "url": "https://github.com/salmansir/salman-SIR"
        },
        "index": 0
      }
    ]
...
const btnbc = {
    ...
    footerText: '*_ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ`}, MessageType.location)
...
break
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `ꪶ𝑺𝑲 𝑫𝜩𝑽𝑰𝑳 𝑺𝜩𝑹ꫂ`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
