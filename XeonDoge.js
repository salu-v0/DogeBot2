...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*𝐒𝐤 𝐃𝐞𝐯𝐢𝐥*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 1: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 2: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 3: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 4: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 5: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 6: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 7: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 8: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 9: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 10: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 11: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 12: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 13: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 14: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 15: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 16: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 17: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 18: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 19: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 20: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 21: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 22: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
                case 23: jamss = "𝐒𝐤 𝐃𝐞𝐯𝐢𝐥"; break;
            }
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*𝐒𝐤 𝐃𝐞𝐯𝐢𝐥*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `𝐒𝐤 𝐃𝐞𝐯𝐢𝐥`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/380945798078?text=*💌🥰sᴋ.ᴅᴇᴠɪʟ.sᴇʀ.ʙɪɢ.ғᴇɴ💌🥰`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*𝐒𝐤 𝐃𝐞𝐯𝐢𝐥*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
ini_list.push({
"displayName": `𝐒𝐤 𝐃𝐞𝐯𝐢𝐥 Developer`,
...
const btnbc = {
    ...
    footerText: '*_𝐒𝐤 𝐃𝐞𝐯𝐢𝐥 BROADCAST_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`𝐒𝐤 𝐃𝐞𝐯𝐢𝐥`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY 𝐒𝐤 𝐃𝐞𝐯𝐢𝐥`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `𝐒𝐤 𝐃𝐞𝐯𝐢𝐥`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `𝐒𝐤 𝐃𝐞𝐯𝐢𝐥`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
